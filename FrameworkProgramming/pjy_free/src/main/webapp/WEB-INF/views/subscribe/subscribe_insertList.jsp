        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              <table width="600">
		  <tr>
		    <td align=center>이름</td><td align=center>가격</td><td align=center>구독상품</td><td align=center>바로가기</td><td align=center>추가하기</td>
		  </tr>
			<c:forEach var="item" items="${subscribe}" >
			  <tr>
			    ...
			    <td align=center>
			      <c:url value="/subscribe/addSubscribe?id=${param.id}&platformId=${item.subId }" var="url"/><a href="${url}">구독</a> 
			    </td>
			  </tr>
		  </c:forEach> 
